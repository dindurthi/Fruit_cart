...
mycursor.execute("CREATE TABLE retailer (retailer_id INT,first_name VARCHAR(255),last_name VARCHAR(255),email VARCHAR(255),address VARCHAR(255),store_id INT,PRIMARY KEY(retailer_id))")
mycursor.execute("CREATE TABLE shopper(shopper_id INT,name VARCHAR(255),email VARCHAR(255),PRIMARY KEY(shopper_id))")
